namespace :dev do
  ...
  task sync_production: :environment do
    system "rsync -av -e ssh rubytw@Tomlan:/home/deploy/2015.rubyconf.tw/shared/public/uploads/ ./public/uploads/"
    system "ssh rubytw@Tomlan pg_dump rubyconftw2015_production -c -O | rails db"
  end
